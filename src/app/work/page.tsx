...
const systems = [
  { n: "01", vertical: "Real Estate", brand: "Lev & On Residential", route: "/showroom/real-estate", tool: "/showroom/real-estate/tools/move-strategy-studio", identity: "Architectural market folio", story: "A high-consideration property journey that turns browsing into preparation, preparation into context, and context into an advisor conversation.", proof: ["Property search + listing detail", "Buying, selling, neighborhoods, intelligence", "Six working decision tools", "Contextual showing and consultation flows"] },
  { n: "02", vertical: "Home Services", brand: "Lev & On Home Services", route: "/showroom/plumbing", tool: "/showroom/plumbing/tools/plumbing-passport", identity: "Technical house-systems manual", story: "A homeowner experience that separates emergency guidance from planned work, makes symptoms easier to communicate, and prepares a useful service request.", proof: ["Emergency-first routing", "Service and territory architecture", "Seven working homeowner tools", "Prepared service request flow"] },
  { n: "03", vertical: "Injury Law", brand: "Lev & On Injury Counsel", route: "/showroom/injury-law", tool: "/showroom/injury-law/case-review", identity: "The Clear Record", story: "A trauma-aware legal journey that replaces pressure with orientation, gives practical next steps, and preserves a calm path to confidential human review.", proof: ["Practice areas + after-accident guidance", "Process, attorneys, and resources", "Six-stage Incident & Impact Review", "Result-first consultation path"] },
];

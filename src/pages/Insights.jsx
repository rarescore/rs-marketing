...
export default function Insights(){const cats=['All',...new Set(articles.map(a=>a.category))];const[filter,setFilter]=useState('All');const visible=filter==='All'?articles:articles.filter(a=>a.category===filter);return <><Seo title="Marketing Insights | LG Growth Studio" description="Original field notes on SEO, creative testing, local growth, paid acquisition and high-converting websites."/>
